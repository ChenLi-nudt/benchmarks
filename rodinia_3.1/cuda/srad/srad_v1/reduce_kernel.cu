...
__global__ void reduce222(	long d_Ne,											// number of elements in array
										int d_no,											// number of sums to reduce
										int d_mul,											// increment
										float *d_sums,										// pointer to partial sums variable (DEVICE GLOBAL MEMORY)
										float *d_sums2){
	...
	// statistical
	__shared__ float d_psum[NUMBER_THREADS];								// data for block calculations allocated by every block in its shared memory
	__shared__ float d_psum2[NUMBER_THREADS];
