...
void bpnn222_layerforward(l1, l2, conn, n1, n2)
float *l1, *l2, **conn;
int n1, n2;
{
  float sum;
...
void bpnn222_adjust_weights(delta, ndelta, ly, nly, w, oldw)
...
BPNN *net;
{
  ...
  bpnn222_layerforward(net->input_units, net->hidden_units,
      net->input_weights, in, hid);
  bpnn222_layerforward(net->hidden_units, net->output_units,
...
float *eo, *eh;
{
  ...
  *eh = hid_err;
  ...
  bpnn222_adjust_weights(net->output_delta, out, net->hidden_units, hid,
      net->hidden_weights, net->hidden_prev_weights);
  bpnn222_adjust_weights(net->hidden_delta, hid, net->input_units, in,
